...
export function PageHeaderSection({ eyebrow, title, subtitle }: PageHeaderSectionProps) {
  return (
    <section className="relative pt-40 pb-20 bg-[#1C1C1E] overflow-hidden">
      <div className="absolute inset-0 opacity-10">
        <div className="absolute -top-24 -right-24 w-80 h-80 bg-[#C9A227] rounded-full" />
      </div>
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <span className="text-[#C9A227] font-bold uppercase text-sm tracking-widest">{eyebrow}</span>
